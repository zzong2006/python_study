...
"""
    ...
    Reference: https://github.com/evandempsey/fp-growth/blob/master/tests/test_pyfpgrowth.py
"""
...
class FPTreeTests(unittest.TestCase):
    ...
    def test_build_header_table(self):
        ...
        self.assertEqual(headers[1], None)
        self.assertEqual(headers[2], None)
        self.assertEqual(headers[6], None)
...
class FPGrowthTests(unittest.TestCase):
    ...
    def test_find_frequent_patterns(self):
        patterns = pyfpgrowth.find_frequent_patterns(self.transactions, self.support_threshold)
